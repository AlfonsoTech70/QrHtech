...
public class CookieStore2  implements CookieStore {
     ...
     */
    public CookieStore2(Context context) {
    ...
    public class SICookie2 implements Serializable {
        ...
        /**
         * A simple wrapper for {@link HttpCookie} to work with {@link CookieStore2}
